...
import { getMigrationModel } from './model.js';
import { DEFAULT_MIGRATE_AUTOSYNC, DEFAULT_MIGRATE_CLI, DEFAULT_MIGRATE_MIGRATIONS_PATH, DEFAULT_MIGRATE_MONGO_COLLECTION } from './defaults.js';
import defaultTemplate from './template.js';
import { register } from '@swc-node/register/register';
register();
export * as IOptions from './interfaces/IOptions.js';
class Migrator {
    constructor(options) {
    ...
    async list() {
        ...
        if (!migrations.length)
            this.log(chalk.yellow('There are no migrations to list'));
